...
from wurthless.clock.drivers.display.forcednumericdisplay import ForcedNumericDisplay
...
-numeric: Force numeric display mode
...
def cursesMain(stdscr):
    ...
    if "-numeric" in sys.argv:
        display = ForcedNumericDisplay(display)
